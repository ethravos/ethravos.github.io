...
- **[[Veyra Sable]]** — _The Quiet Tap_
- **Silas Grin** — _Smiley_
- **Nyx Holmere** — _Night Key_
- **Rathen Crowl** — _Dead Bow_
- **Tamille Widowfen** — _Gravewife_
- **Fenric Gallow** — _Burn Drop_
- **Kethra** — _The Hangman’s Favor_

---
## **Smugglers**

- **Corin Ashlock** — _Cinder Key_
- **Mirek Coil** — _The Switchback_
- **Jorren Knell** — _Dockbell_
- **Velis Murk** — _Low Tide_
- **Maive Dreg** — _Bottom-Barrel_
- **Allig** — _The Locksmith_

---
## **Thieves**

- **Elowen Sable** — _Black Velvet_
- **Kael Vire** — _Glasshand_
- **Iscra Vell** — _Second Shadow_
- **Dask Rook** — _Dask_
- **Lyza Thornmark** — _Briarhand_
- **Soren Palehook** — _The Angle_
